...
<div class="page">
  ...
  <MetronomeBounce tempoMs={480} durationSeconds={exercise.durationSeconds} preparationLabel={t[locale.value].preparePelvis} onComplete={() => {
    stopAllAudio();
    cancelSpeech();
    goto(getNextExerciseHref(7));
  }} />
