<script lang="ts">
  ...
  import TensionMeter from '$lib/TensionMeter.svelte';
...
<style>
  ...
  .end-button { margin-top: auto; border: 0; background: #1e3a8a; color: #f8fafc; padding: 0.9rem 2rem; border-radius: 8px; font: inherit; font-weight: 600; cursor: pointer; }
</style>